...
import com.okayo.facturation.entities.CaracteristiqueId;
import com.okayo.facturation.repositories.ArticleRepository;
import com.okayo.facturation.repositories.CaracteristiqueRepository;
...
public Article createArticle(ArticleDTO dto){
    ...
    if(dto.nom != null || dto.prix != null || dto.tva != null){
        ...
        a.getCaracteristiques().add(c);  // ← ajoute directement à la liste
